...
var configure_delegation_exports = {};
__export(configure_delegation_exports, {
  createDelegation: () => createDelegation,
  findActiveDelegation: () => findActiveDelegation,
  handler: () => handler
});
module.exports = __toCommonJS(configure_delegation_exports);
...
// src/handlers/configure-delegation.ts
async function createDelegation(db, tenantId, delegation) {
...
async function handler(event, _context) {
  ...
  try {
    ...
    const delegationId = (0, import_node_crypto.randomUUID)();
...
//# sourceMappingURL=configure-delegation.js.map
