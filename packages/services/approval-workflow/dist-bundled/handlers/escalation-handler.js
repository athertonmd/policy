...
// src/handlers/escalation-handler.ts
var escalation_handler_exports = {};
__export(escalation_handler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(escalation_handler_exports);
  ...
  try {
    const result = await withDatabase(async (db) => {
      ...
      if (applicableRule) {
        ...
        escalationTarget = lastRule ? resolveEscalationTarget(lastRule.escalateTo) : "tenant-admin";
      }
...
function resolveEscalationTarget(rule) {
  switch (rule.type) {
    case "role":
