...
// src/handlers/run-migration.ts
var { Client: Client2 } = esm_default;
...
async function getDbCredentials() {
  ...
  const response = await secretsClient.send(new import_client_secrets_manager.GetSecretValueCommand({ SecretId: secretArn }));
