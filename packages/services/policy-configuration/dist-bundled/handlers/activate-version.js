...
// src/handlers/activate-version.ts
var activate_version_exports = {};
__export(activate_version_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(activate_version_exports);
...
async function activateRule(db, tenantId, ruleId) {
  ...
  const result = await db.query(
    `UPDATE ${schemaName}.policy_rules
     ...
     RETURNING *`,
    [(/* @__PURE__ */ new Date()).toISOString(), ruleId, tenantId]
  );
...
//# sourceMappingURL=activate-version.js.map
