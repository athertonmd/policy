...
// src/handlers/save-rule.ts
var save_rule_exports = {};
__export(save_rule_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(save_rule_exports);
...
async function saveRule(db, params) {
  const ruleId = (0, import_node_crypto.randomUUID)();
...
function validateSaveRuleRequest(request) {
  ...
  if (request.priority === void 0 || request.priority === null) {
...
async function publishRuleChangedEvent(tenantId, ruleId, action, requestId) {
...
//# sourceMappingURL=save-rule.js.map
